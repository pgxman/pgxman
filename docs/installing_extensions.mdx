...
pgxman will install the latest version of pgvector into the local detected version of Postgres. On Mac, it will use
...
You can also utilize a [pgxman.yaml](spec/pgxman.yaml) file to install or upgrade
